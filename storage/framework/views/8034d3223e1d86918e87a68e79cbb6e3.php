...
<body>
    <div class="hero-navbar">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end">
                    <ul class="navbar-nav me-3">
                        <li class="nav-item">
                            <a class="nav-link underline-hover" href="<?php echo e(url('/upload')); ?>"
        ...
        <section class="hero scroll-reveal">
            <div class="container">
                ...
                <div class="mt-4">
                    <a href="<?php echo e(url('/upload')); ?>" class="btnlight">Convert</a>
                    <a href="<?php echo e(url('/')); ?>" class="btn-blur">Coming Soon&nbsp; →</a>
                </div>
            </div>
        </section>
    </div>
    ...
    <section id="sect-2" class="scroll-reveal">
        <div class="row">
            <div class="col">
                <img src="<?php echo e(asset('img/8767132-Photoroom.png')); ?>" alt="" width="400px">
            </div>
            <div class="col">
    ...
    <section id="sect-3" class="scroll-reveal">
        <div class="row">
            ...
            <div class="col">
                <img src="<?php echo e(asset('img/20943418-Photoroom.png')); ?>" alt="" width="500px">
            </div>
        </div>
    </section>
...
<?php /**PATH C:\laragon\www\Project-Inggris\resources\views/index.blade.php ENDPATH**/ ?>